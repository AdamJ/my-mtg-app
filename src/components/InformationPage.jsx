...
function InformationPage() {
  ...
  return (
    <PageTemplate title="Information"> {/* Set the title */}
      <VersionDialog title="Version History" buttonText={latestVersion ? `Latest Version: ${latestVersion.version}` : "Version History"}>
        {previousVersions.length > 0 && ( // Only show the list if there are previous versions
          <List sx={{ width: '100%', minWidth: 360, bgcolor: 'background.paper' }}>
            ...
            <ListItem component="a" href="https://github.com/AdamJ/my-mtg-app/releases" target="_blank" rel="noopener">
      ...
      <h2>What Is This?</h2>
      <p>
        Basically, this is a life counter and deck list &quot;app&quot; that I use when I play at Cube events. All of the other counters and/or deck builders that I&apos;ve used are great in their own ways, but I wanted to make something for myself that I could customize. If others like it, maybe I&apos;ll share it or distribute it through one of the app stores.
      </p>
      <p>
        This app is a project to demonstrate the use of <a href="https://react.dev">React</a> and <a href="https://mui.com/material-ui/">Material-UI</a> components to create a simple Magic: The Gathering (MTG) application.
      </p>
      <h2>Resources</h2>
      <ul>
        <li>
          <a href="https://mana.andrewgioia.com/icons.html">Mana and Card icons</a> by <a href="https://andrewgioia.com">Andrew Gioia</a>
        </li>
      </ul>
      <h2>Disclaimer</h2>
      <p>
